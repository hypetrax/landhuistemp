    ...
    <div className="coming-soon">
      <header className="header">
        <div className="container header-inner">
          <div className="logo">
            <img src="/logo.svg" alt="Landhuis Installatietechniek Logo" className="logo-img" width="180" height="60" />
        ...
        <div className="container hero-inner">
          <section className="hero-content">
            ...
            <div className="cta-group">
              <a href="tel:0636499203" className="btn btn-primary" aria-label="Bel 06 36499203">
                <Phone size={18} />
                06 36499203
              </a>
              <a href="https://wa.me/31636499203" className="btn btn-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Landhuis Installatietechniek">
        ...
        <div className="container footer-inner">
          <div className="footer-info">
            ...
            <div className="footer-item">
              ...
              <a href="tel:0636499203">06 36499203</a>
            </div>
            <div className="footer-item">
